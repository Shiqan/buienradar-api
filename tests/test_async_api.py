...
@pytest.fixture()
async def buienradar():
    async with AsyncBuienradarApi() as buienradar:
        yield buienradar

@patch('buienradar.AsyncBuienradarApi._request')
@pytest.mark.asyncio
async def test_fivedayforecast(mock_response, buienradar):
    mock_response.return_value = response
    forecast = await buienradar.get_forecast()
